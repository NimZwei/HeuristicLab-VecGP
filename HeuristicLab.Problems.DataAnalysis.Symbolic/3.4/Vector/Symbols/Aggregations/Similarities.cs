...
[Item("EuclideanDistance", "Symbol that represents the Euclidean distance function."), StorableType("5477A8C6-E557-4E2E-9326-16DF26F5D6A8")]
public sealed class EuclideanDistance : Symbol {
  ...
  public EuclideanDistance() : base("EuclideanDistance", "Symbol that represents the Euclidean distance function.") { }
}
