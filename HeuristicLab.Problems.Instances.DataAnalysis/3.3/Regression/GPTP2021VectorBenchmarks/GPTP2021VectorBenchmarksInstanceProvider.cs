...
public class GPTP2021VectorBenchmarksInstanceProvider : ResourceRegressionInstanceProvider {
  public override string Name {
    get { return "GPTP 2021 Vector Benchmark Problems"; }
  }
  ...
  public override IEnumerable<IDataDescriptor> GetDataDescriptors() {
    return new List<ResourceRegressionDataDescriptor> {
        ...
        new GPTP2021VectorBenchmarkDataDescriptor("test_C_01A", new []{ "x1", "x2", "v1", "v2", "v3", "v4", "v5", "v6"}, "y1"),
        new GPTP2021VectorBenchmarkDataDescriptor("test_C_01B", new []{ "x1", "x2", "v1", "v2", "v3", "v4", "v5", "v6"}, "y2"),
        new GPTP2021VectorBenchmarkDataDescriptor("test_C_01C", new []{ "x1", "x2", "v1", "v2", "v3", "v4", "v5", "v6"}, "y3"),
        new GPTP2021VectorBenchmarkDataDescriptor("test_C_01D", new []{ "x1", "x2", "v1", "v2", "v3", "v4", "v5", "v6"}, "y4"),
        //new GPTP2021VectorBenchmarkDataDescriptor("test_B_14", new []{ "x1", "x2", "x3", "x4", "x5", "v1", "v2", "v3", "v4", "v5", "v6", "v7", "v8" }),
        ...
        //new GPTP2021VectorBenchmarkDataDescriptor("unrolled_test_B_04", Flatten(S("x1"), S("x2"), U("v1"), U("v2"), U("v3"), U("v4"))),
        ...
        new GPTP2021VectorBenchmarkDataDescriptor("unrolled_test_C_01", Flatten(S("x1"), S("x2"), U("v1"), U("v2"), U("v3"), U("v4"), U("v5"), U("v6")), "y1"),
        new GPTP2021VectorBenchmarkDataDescriptor("unrolled_test_C_01", Flatten(S("x1"), S("x2"), U("v1"), U("v2"), U("v3"), U("v4"), U("v5"), U("v6")), "y2"),
        new GPTP2021VectorBenchmarkDataDescriptor("unrolled_test_C_01", Flatten(S("x1"), S("x2"), U("v1"), U("v2"), U("v3"), U("v4"), U("v5"), U("v6")), "y3"),
        new GPTP2021VectorBenchmarkDataDescriptor("unrolled_test_C_01", Flatten(S("x1"), S("x2"), U("v1"), U("v2"), U("v3"), U("v4"), U("v5"), U("v6")), "y4"),
        //new GPTP2021VectorBenchmarkDataDescriptor("unrolled_test_B_14", Flatten(S("x1"), S("x2"), S("x3"), S("x4"), S("x5"), U("v1"), U("v2"), U("v3"), U("v4"), U("v5"), U("v6"), U("v7"), U("v8"))),
        ...
        //new GPTP2021VectorBenchmarkDataDescriptor("pre_aggregated_test_B_04", Flatten(S("x1"), S("x2"), A("v1"), A("v2"), A("v3"), A("v4"))),
        ...
        new GPTP2021VectorBenchmarkDataDescriptor("pre_aggregated_test_C_01", Flatten(S("x1"), S("x2"), A("v1"), A("v2"), A("v3"), A("v4"), A("v5"), A("v6")), "y1"),
        new GPTP2021VectorBenchmarkDataDescriptor("pre_aggregated_test_C_01", Flatten(S("x1"), S("x2"), A("v1"), A("v2"), A("v3"), A("v4"), A("v5"), A("v6")), "y2"),
        new GPTP2021VectorBenchmarkDataDescriptor("pre_aggregated_test_C_01", Flatten(S("x1"), S("x2"), A("v1"), A("v2"), A("v3"), A("v4"), A("v5"), A("v6")), "y3"),
        new GPTP2021VectorBenchmarkDataDescriptor("pre_aggregated_test_C_01", Flatten(S("x1"), S("x2"), A("v1"), A("v2"), A("v3"), A("v4"), A("v5"), A("v6")), "y4"),
        //new GPTP2021VectorBenchmarkDataDescriptor("pre_aggregated_test_B_14", Flatten(S("x1"), S("x2"), S("x3"), S("x4"), S("x5"), A("v1"), A("v2"), A("v3"), A("v4"), A("v5"), A("v6"), A("v7"), A("v8"))),
  ...
  private static T[] Flatten<T>(params IEnumerable<T>[] values) {
    return values.SelectMany(x => x).ToArray();
  }
  private static IEnumerable<string> S(string name) {
    yield return name;
  }
  // Unroll vector variable name
  private static IEnumerable<string> U(string name, int length = 20) {
    return Enumerable.Range(0, length).Select(i => name + "_" + i);
  }
  // Pre-aggregated variable name
  private static readonly string[] DefaultAggregationNames = { "sum", "mean", "std", "var", "median", "amin", "amax" };
  private static IEnumerable<string> A(string name, string[] aggregationNames = null) {
    aggregationNames = aggregationNames ?? DefaultAggregationNames;
